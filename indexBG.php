  ...
  <body data-spy="scroll" data-target=".navbar-default">
    ...
    <div class="about-inner">
      <div class="container">
        ...
        <div class="answer-section">
          <h3>R.S.V.P. - моля отговорете на поканата преди 1-ви май</h3>
...
<!--             <p>ТУК ПИШЕШ ТИ!!!
            ...
            <blockquote>
              Наси е душевно най-красивият човек, с който съм се запознавал. 
              </br>
              Не е имало друг, който да ме задължи да спра каквото правя и да вървя сума време, за да ми покаже "нещо важно" и като стигнем там да ми посочи страхотна луна или залез с пълна усмивка на лице. 
              </br>
  ...
  <!-- begin:ceremony -->
  <section id="ceremony" style="background-image: url(img/1.jpg);" class="adventure">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1>Церемонията</h1>
            ...
            <li>
              ...
              <ul>
                ...
                <li class="content-item content-chat">
                  ...
                  <div class="text">Тя казва не. Той стои до нея с пръстен в джоба, изражението на лицето му - безценно. Обяснението й - той е с 4 години по-млад, не иска да го притиска да прави нещо, за което не е готов. Това го успокоява и по късно същият ден смело предлага брак!</div>
